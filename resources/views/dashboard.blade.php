                                            ...
                                            <path
                                                d="M9.9,16.6c-0.3,0-0.7-0.1-0.9-0.4L4.4,11c-0.5-0.5-0.5-1.3,0-1.8s1.3-0.5,1.8,0l3.7,3.7l7.8-7.8 c0.5-0.5,1.3-0.5,1.8,0s0.5,1.3,0,1.8L10.8,16.2C10.6,16.5,10.2,16.6,9.9,16.6z"">
                                                                                    ...
                                                                                    <svg viewBox="0 0 24 24" class="arr-1" xmlns="http://www.w3.org/2000/svg">
                                                                                        <path
                                                                                            d="
                                                M9.9,16.6c-0.3,0-0.7-0.1-0.9-0.4L4.4,11c-0.5-0.5-0.5-1.3,0-1.8s1.3-0.5,1.8,0l3.7,3.7l7.8-7.8
                                                c0.5-0.5,1.3-0.5,1.8,0s0.5,1.3,0,1.8L10.8,16.2C10.6,16.5,10.2,16.6,9.9,16.6z"">
                                            </path>
                                        </svg>
                                    </button>
                                </div>
