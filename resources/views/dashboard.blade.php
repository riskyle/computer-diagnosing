                                    ...
                                    <form id="issue-form" action="" method="POST">
                                        ...
                                        {{-- <div class=" col-12 d-flex flex-row align-items-center mb-3">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <label for="q1" class="txt">That device is Desktop or
                                                    Laptop?</label>
                                        ...
                                        <div class=" col-12 d-flex flex-row align-items-center mb-3">
                                            <div class="form-outline flex-fill mb-0">
                                                {{-- label --}}
                                                <label for="" class="txt">Input the serial number so you can
                                                    identify
                                                    your device.</label>
                                                <div class=" clr-line">
                                                    {{-- sellect/input --}}
                                        ...
                                        <div class=" col-12 d-flex flex-row align-items-center mb-3">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                {{-- label --}}
                                                <label for="issue2" class="txt">Keyboard Issues:</label>
                                                <div class=" clr-line">
                                                    {{-- sellect/input --}}
                                        ...
                                        <div class=" col-12 d-flex flex-row align-items-center mb-3">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                {{-- label --}}
                                                <label for="issue3" class="txt">Mouse/Pointer Issues:</label>
                                                <div class=" clr-line">
                                                    {{-- sellect/input --}}
                                        ...
                                        <div class=" col-12 d-flex flex-row align-items-center mb-3">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                {{-- label --}}
                                                <label for="issue4" class="txt">Display Issues:</label>
                                                <div class=" clr-line">
                                                    {{-- sellect/input --}}
