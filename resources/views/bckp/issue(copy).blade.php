            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="issue-form2" action="" method="POST">
                        ...
                        {{-- label --}}
                        <label for="issue1" class="mt-3">Select an Issue:</label>
                        <div class=" clr-line">
                            {{-- sellect/input --}}
                            <select id="issue1" name="issue1" class="boxs">
                                ...
                                <option value="blue screen of death (BSOD) errors">Blue Screen of Death (BSOD)</option>
                        ...
                        {{-- label --}}
                        <label for="issue2">Select an Issue:</label>
                        <div class=" clr-line">
                            {{-- sellect/input --}}
                        ...
                        {{-- label --}}
                        <label for="issue3">Select an Issue:</label>
                        <div class=" clr-line">
                            {{-- sellect/input --}}
                            ...
                            <select id="issue3" name="issue3" class="boxs">
                                ...
                                <option value="">None</option>
                                <option value="pointer drift">Pointer Drift or Inaccuracy</option>
                        ...
                        {{-- label --}}
                        <label for="issue4">Select an Issue:</label>
                        <div class=" clr-line">
                            {{-- sellect/input --}}
                        ...
                        <div class=" clr-line">
                            {{-- sellect/input --}}
                            <select id="issue5" name="issue5" class="boxs">
            ...
            <main class="cd__main">
                <table id="issues" class=" display table table-hover table-striped table-bordered ">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">Issue 1</th>
                            <th scope="col">Issue 2</th>
                            <th scope="col">Issue 3</th>
                            <th scope="col">Issue 4</th>
                            <th scope="col">Issue 5</th>
    ...
    <script>
        ...
        $("button#diagnose-btn").on("click", async (e) => {
            if (issueForm2[1].value != "" || issueForm2[2].value != "" || issueForm2[3].value != "" ||
                ...
                const issues = {
                    issue1: issueForm2[5].value,
                    issue2: issueForm2[6].value,
                    issue3: issueForm2[7].value,
                    issue4: issueForm2[8].value,
                    issue5: issueForm2[9].value,
                }
                try {
